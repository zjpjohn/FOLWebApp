...
/**
 * <p>changeSubmitToRejectResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeSubmitToRejectResponse">
 *   &lt;complexContent>
...
@XmlType(name = "changeSubmitToRejectResponse", propOrder = {
    "_return"
})
public class ChangeSubmitToRejectResponse {
