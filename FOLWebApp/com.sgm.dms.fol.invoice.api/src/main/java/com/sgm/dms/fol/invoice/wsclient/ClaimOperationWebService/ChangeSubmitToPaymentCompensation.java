...
/**
 * <p>changeSubmitToPaymentCompensation complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeSubmitToPaymentCompensation">
 *   &lt;complexContent>
...
@XmlType(name = "changeSubmitToPaymentCompensation", propOrder = {
    "arg0"
})
public class ChangeSubmitToPaymentCompensation {
