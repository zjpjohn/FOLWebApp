...
/**
 * <p>changeInvoiceToPaymentCompensationResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeInvoiceToPaymentCompensationResponse">
 *   &lt;complexContent>
...
@XmlType(name = "changeInvoiceToPaymentCompensationResponse", propOrder = {
    "_return"
})
public class ChangeInvoiceToPaymentCompensationResponse {
