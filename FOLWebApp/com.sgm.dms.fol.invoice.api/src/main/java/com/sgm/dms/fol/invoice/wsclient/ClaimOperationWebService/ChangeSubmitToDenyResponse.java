...
/**
 * <p>changeSubmitToDenyResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeSubmitToDenyResponse">
 *   &lt;complexContent>
...
@XmlType(name = "changeSubmitToDenyResponse", propOrder = {
    "_return"
})
public class ChangeSubmitToDenyResponse {
