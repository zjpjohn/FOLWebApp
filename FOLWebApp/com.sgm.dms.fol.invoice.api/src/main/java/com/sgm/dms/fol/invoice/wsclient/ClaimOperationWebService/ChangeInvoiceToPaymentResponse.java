...
/**
 * <p>changeInvoiceToPaymentResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeInvoiceToPaymentResponse">
 *   &lt;complexContent>
...
@XmlType(name = "changeInvoiceToPaymentResponse", propOrder = {
    "_return"
})
public class ChangeInvoiceToPaymentResponse {
