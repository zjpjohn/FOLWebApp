...
/**
 * <p>changeSubmitToDenyCompensationResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeSubmitToDenyCompensationResponse">
 *   &lt;complexContent>
...
@XmlType(name = "changeSubmitToDenyCompensationResponse", propOrder = {
    "_return"
})
public class ChangeSubmitToDenyCompensationResponse {
