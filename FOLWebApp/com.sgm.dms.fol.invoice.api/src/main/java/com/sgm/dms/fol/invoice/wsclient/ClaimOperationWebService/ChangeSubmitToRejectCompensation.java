...
/**
 * <p>changeSubmitToRejectCompensation complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeSubmitToRejectCompensation">
 *   &lt;complexContent>
...
@XmlType(name = "changeSubmitToRejectCompensation", propOrder = {
    "arg0"
})
public class ChangeSubmitToRejectCompensation {
