...
/**
 * <p>changeSubmitToPaymentCompensationResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeSubmitToPaymentCompensationResponse">
 *   &lt;complexContent>
...
@XmlType(name = "changeSubmitToPaymentCompensationResponse", propOrder = {
    "_return"
})
public class ChangeSubmitToPaymentCompensationResponse {
