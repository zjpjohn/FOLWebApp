...
/**
 * <p>changeInvoiceToPaymentCompensation complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeInvoiceToPaymentCompensation">
 *   &lt;complexContent>
...
@XmlType(name = "changeInvoiceToPaymentCompensation", propOrder = {
    "arg0"
})
public class ChangeInvoiceToPaymentCompensation {
