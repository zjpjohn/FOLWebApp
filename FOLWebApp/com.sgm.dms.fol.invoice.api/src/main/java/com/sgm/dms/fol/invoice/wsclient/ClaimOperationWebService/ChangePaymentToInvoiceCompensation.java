...
/**
 * <p>changePaymentToInvoiceCompensation complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changePaymentToInvoiceCompensation">
 *   &lt;complexContent>
...
@XmlType(name = "changePaymentToInvoiceCompensation", propOrder = {
    "arg0"
})
public class ChangePaymentToInvoiceCompensation {
