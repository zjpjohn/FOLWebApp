...
/**
 * <p>changePaymentToInvoice complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changePaymentToInvoice">
 *   &lt;complexContent>
...
@XmlType(name = "changePaymentToInvoice", propOrder = {
    "arg0"
})
public class ChangePaymentToInvoice {
