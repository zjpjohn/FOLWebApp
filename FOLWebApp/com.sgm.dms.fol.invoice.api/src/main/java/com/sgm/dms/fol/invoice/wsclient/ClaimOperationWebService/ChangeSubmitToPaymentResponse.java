...
/**
 * <p>changeSubmitToPaymentResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeSubmitToPaymentResponse">
 *   &lt;complexContent>
...
@XmlType(name = "changeSubmitToPaymentResponse", propOrder = {
    "_return"
})
public class ChangeSubmitToPaymentResponse {
