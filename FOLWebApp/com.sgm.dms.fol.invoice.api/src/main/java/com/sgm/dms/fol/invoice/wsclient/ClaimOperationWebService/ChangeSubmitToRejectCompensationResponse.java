...
/**
 * <p>changeSubmitToRejectCompensationResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="changeSubmitToRejectCompensationResponse">
 *   &lt;complexContent>
...
@XmlType(name = "changeSubmitToRejectCompensationResponse", propOrder = {
    "_return"
})
public class ChangeSubmitToRejectCompensationResponse {
