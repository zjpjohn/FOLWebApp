...
public class ReturnAllowanceInfoVo extends BaseVo{
	 ...
	 * 退货证明单信息
	 */
	private ReturnOrderInfoVo returnOrderInfo;//退货证明单号
	/*
	 * XML信息
	 */
	...
	public ReturnOrderInfoVo getReturnOrderInfo() {
		return returnOrderInfo;
	}
	public void setReturnOrderInfo(ReturnOrderInfoVo returnOrderInfo) {
